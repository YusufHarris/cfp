...
<!-- image gallery -->
        <div id="images" class="pt-5 pb-4s"></div>
        <div class="container text-center">
            ...
            <div class="col-md-3 mb-4 text-center">
                        <a href="{{route('image.index')}}">
                          ...
                          <p class="text-center text-dark text-uppercase">Main Gallery</p>
                        </a>
                ...
                @foreach ($employees as $employee)
                      <div class="col-md text-center">
                        <ul style="list-style-type:none;">
                          ...
                          <li><img src="{{$employee->avatar}}" onerror="this.src='https://i.imgur.com/fitWknA.png';" width="150px" height="150px" style="border-radius:50px;" alt="{{$employee->name}} Photo"/></p>
